...
## ⚠️ 重要声明
本项目是 [baiduwp](https://github.com/yuantuo666/baiduwp-php) 的 修复版，修复了解析接口失效的问题
...
3. 在 软件商店 —— 你的PHP版本 —— 设置 —— 安装扩展 —— sg15 —— 安装，安装sg15扩展（必须！）
...
- [原baiduwp-php项目](https://github.com/yuantuo666/baiduwp-php "baiduwp-php 项目")
